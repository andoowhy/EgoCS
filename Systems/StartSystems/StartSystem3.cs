namespace EgoCS
{
    public abstract class StartSystem< TEgoInterface, TEgoConstraint1, TEgoConstraint2, TEgoConstraint3 > : StartSystem< TEgoInterface >
...

    {
        ...
        public abstract void Start( TEgoInterface egoInterface, TEgoConstraint1 constraint1, TEgoConstraint2 constraint2, TEgoConstraint3 constraint3 );
        ...
        {
            Start( egoInterface, constraint1, constraint2, constraint3 );
        }
