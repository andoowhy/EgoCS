namespace EgoCS
{
    public abstract class EgoStartSystem< TEgoInterface, TEgoConstraint1, TEgoConstraint2, TEgoConstraint3, TEgoConstraint4, TEgoConstraint5, TEgoConstraint6 > : EgoStartSystem< TEgoInterface >
...

    {
        ...
        public abstract void Start( TEgoInterface egoInterface, TEgoConstraint1 constraint1, TEgoConstraint2 constraint2, TEgoConstraint3 constraint3, TEgoConstraint4 constraint4, TEgoConstraint5 constraint5, TEgoConstraint6 constraint6 );
        ...
        {
            Start( egoInterface, constraint1, constraint2, constraint3, constraint4, constraint5, constraint6 );
        }
