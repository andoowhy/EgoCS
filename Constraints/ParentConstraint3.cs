...
namespace EgoCS
{
    public class ParentConstraint< TComponent1, TComponent2, TComponent3, CS1 > : ParentConstraint, IEnumerable< (EgoComponent, TComponent1, TComponent2, TComponent3, CS1) >
        ...
        where CS1 : Constraint, new()
    {
        ...
        IEnumerator< (EgoComponent, TComponent1, TComponent2, TComponent3, CS1) > IEnumerable< (EgoComponent, TComponent1, TComponent2, TComponent3, CS1) >.GetEnumerator()
        {
            ...
            foreach( var kvp in lookup )
            {
                ...
                yield return ( currentEgoComponent, bundle.component1, bundle.component2, bundle.component3, childConstraint as CS1 );
            }
        }
