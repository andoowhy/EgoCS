namespace EgoCS
{
        ...
        where CS1 : Constraint, new()
    {
        public ParentConstraint()
        {
            ...
            _mask[ ComponentUtils.Get< TComponent11 >() ] = true;
            _mask[ ComponentUtils.Get< TComponent12 >() ] = true;
        ...
        public override void CreateConstraintCallbacks( EgoCS egoCS )
        {
            ...
            egoCS.AddDestroyedComponentCallback( typeof( TComponent11 ), CreateBundles );

            egoCS.AddAddedComponentCallback( typeof( TComponent12 ), CreateBundles );
            egoCS.AddDestroyedComponentCallback( typeof( TComponent12 ), CreateBundles );
