namespace EgoCS
{
    ...
    public class Constraint< C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12 > : Constraint, IEnumerable< (EgoComponent, C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12) >
        where C1 : Component
        where C2 : Component
        where C3 : Component
        where C4 : Component
        ...
        where C12 : Component
    {
        ...
        IEnumerator< (EgoComponent, C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12) > IEnumerable< (EgoComponent, C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12) >.GetEnumerator()
        {
