...
public class EgoParentConstraint< C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, CS1 > : EgoParentConstraint, IEnumerable< (EgoComponent, C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, CS1) >
    where C1 : Component
    where C2 : Component
    where C3 : Component
    where C4 : Component
    ...
    where CS1 : EgoConstraint, new()
{
    ...
    public override void CreateConstraintCallbacks( EgoInterface egoInterface )
    {
        ...
        egoInterface.AddAddedComponentCallback( typeof( C11 ), CreateBundles );
        egoInterface.AddDestroyedComponentCallback( typeof( C11 ), CreateBundles );

        egoInterface.AddAddedComponentCallback( typeof( C12 ), CreateBundles );
        egoInterface.AddDestroyedComponentCallback( typeof( C12 ), CreateBundles );
