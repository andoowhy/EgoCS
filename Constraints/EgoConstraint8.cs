namespace EgoCS
{
    ...
    public class EgoConstraint< C1, C2, C3, C4, C5, C6, C7, C8 > : EgoConstraint, IEnumerable< (EgoComponent, C1, C2, C3, C4, C5, C6, C7, C8) >
        where C1 : Component
        where C2 : Component
        where C3 : Component
        where C4 : Component
        ...
        where C8 : Component
    {
        ...
        {
            return new EgoBundle< C1, C2, C3, C4, C5, C6, C7, C8 >(
        ...
        IEnumerator< (EgoComponent, C1, C2, C3, C4, C5, C6, C7, C8 ) > IEnumerable< (EgoComponent, C1, C2, C3, C4, C5, C6, C7, C8) >.GetEnumerator()
        {
