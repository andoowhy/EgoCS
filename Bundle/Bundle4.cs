namespace EgoCS
{
    ...
    public class Bundle< TComponent1, TComponent2, TComponent3, TComponent4 > : Bundle
        ...
        where TComponent4 : Component
    {
        ...
        public Bundle( TComponent1 component1, TComponent2 component2, TComponent3 component3, TComponent4 component4 )
        {
