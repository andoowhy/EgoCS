namespace EgoCS
{
    ...
    public class Bundle< C1, C2, C3, C4, C5, C6, C7 > : Bundle
        where C1 : Component
        where C2 : Component
        where C3 : Component
        where C4 : Component
        ...
        where C7 : Component
    {
        ...
        public Bundle( C1 component1, C2 component2, C3 component3, C4 component4, C5 component5, C6 component6, C7 component7 )
        {
