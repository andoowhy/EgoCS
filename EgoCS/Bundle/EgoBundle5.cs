...
public class EgoBundle<C1, C2, C3, C4, C5> : EgoBundle
    where C1 : Component
    where C2 : Component
    where C3 : Component
    where C4 : Component
    where C5 : Component
{
    ...
    public EgoBundle( Transform transform, C1 component1, C2 component2, C3 component3, C4 component4, C5 component5 )
    {
