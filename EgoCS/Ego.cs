...
public static class Ego
{
    public static void AddGameObject( GameObject gameObject )
    {
        ...
        EgoEvents<AddedGameObject>.Queue( new AddedGameObject( gameObject, egoComponent ) );
    }

    public static void DestroyGameObject( GameObject gameObject )
    {
        var egoComponent = gameObject.GetComponent<EgoComponent>();
        EgoEvents<DestroyedGameObject>.Queue( new DestroyedGameObject( gameObject, egoComponent ) );
    ...
    public static C AddComponent<C>( GameObject gameObject ) where C : Component
    {
        ...
        EgoEvents<AddedComponent<C>>.Queue( e );
        return component;
    }
    ...
    public static void DestroyComponent<C>( C component ) where C : Component
    {
        ...
        EgoEvents<DestroyedComponent<C>>.Queue( e );
