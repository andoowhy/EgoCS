    ...
    where C6 : Component
{
    ...
    public virtual void Start()
    {
        ...
        {
            Start( bundle.egoComponent, bundle.component1, bundle.component2, bundle.component3, bundle.component4, bundle.component5, bundle.component6 );
        }
    }
    ...
    public virtual void Update()
    {
        foreach( var bundle in bundles )
        {
            Update( bundle.egoComponent, bundle.component1, bundle.component2, bundle.component3, bundle.component4, bundle.component5, bundle.component6 );
        }
    }
    ...
    public virtual void FixedUpdate()
    {
        foreach( var bundle in bundles )
        {
            FixedUpdate( bundle.egoComponent, bundle.component1, bundle.component2, bundle.component3, bundle.component4, bundle.component5, bundle.component6 );
        }
    }

    public virtual void Start( EgoComponent egoComponent, C1 component1, C2 component2, C3 component3, C4 component4, C5 component5, C6 component6 ) { }

    public virtual void Update( EgoComponent egoComponent, C1 component1, C2 component2, C3 component3, C4 component4, C5 component5, C6 component6 ) { }

    public virtual void FixedUpdate( EgoComponent egoComponent, C1 component1, C2 component2, C3 component3, C4 component4, C5 component5, C6 component6 ) { }
