...
public class EgoSystem<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10> : EgoSystem
    where C1 : Component
    where C2 : Component
    where C3 : Component
    where C4 : Component
    ...
    where C10 : Component
{
    protected Dictionary<EgoComponent, EgoBundle<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10>> _bundles = new Dictionary<EgoComponent, EgoBundle<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10>>();

    protected delegate void ForEachGameObjectDelegate( EgoComponent egoComponent, C1 component1, C2 component2, C3 component3, C4 component4, C5 component5, C6 component6, C7 component7, C8 component8, C9 component9, C10 component10 );
    ...
    protected void CreateBundle( EgoComponent egoComponent, C10 component10 )
    {
        if( Ego.CanUpdate( _mask, egoComponent.mask ) )
        {
            var component1 = egoComponent.GetComponent<C1>();
    ...
    protected void CreateBundle( EgoComponent egoComponent, C1 component1, C2 component2, C3 component3, C4 component4, C5 component5, C6 component6, C7 component7, C8 component8, C9 component9, C10 component10 )
    {
        var bundle = new EgoBundle<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10>( egoComponent, component1, component2, component3, component4, component5, component6, component7, component8, component9, component10 );
    ...
    protected void ForEachGameObject( ForEachGameObjectDelegate callback )
    {
        ...
        {
            callback( bundle.egoComponent, bundle.component1, bundle.component2, bundle.component3, bundle.component4, bundle.component5, bundle.component6, bundle.component7, bundle.component8, bundle.component9, bundle.component10 );
        }
    }
    ...
    void Handle( AddedComponent<C10> e )
    {
        CreateBundle( e.egoComponent );
    }
    ...
    void Handle( DestroyedComponent<C10> e )
    {
        RemoveBundle( e.egoComponent );
    }
}
