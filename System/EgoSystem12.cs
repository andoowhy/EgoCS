    ...
    where C12 : Component
{
    ...
    protected void CreateBundle( EgoComponent egoComponent, C11 component11 )
    {
        if( Ego.CanUpdate( _mask, egoComponent.mask ) )
        {
            var component1 = egoComponent.GetComponent<C1>();
    ...
    protected void CreateBundle( EgoComponent egoComponent, C12 component12 )
    {
        if( Ego.CanUpdate( _mask, egoComponent.mask ) )
        {
            var component1 = egoComponent.GetComponent<C1>();
    ...
    protected void CreateBundle( EgoComponent egoComponent, C1 component1, C2 component2, C3 component3, C4 component4, C5 component5, C6 component6, C7 component7, C8 component8, C9 component9, C10 component10, C11 component11, C12 component12 )
    {
        var bundle = new EgoBundle<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12>( egoComponent, component1, component2, component3, component4, component5, component6, component7, component8, component9, component10, component11, component12 );
    ...
    void Handle( AddedComponent<C11> e )
    {
        CreateBundle( e.egoComponent );
    }

    void Handle( AddedComponent<C12> e )
    {
        CreateBundle( e.egoComponent );
    }
    ...
    void Handle( DestroyedComponent<C11> e )
    {
        RemoveBundle( e.egoComponent );
    }

    void Handle( DestroyedComponent<C12> e )
    {
        RemoveBundle( e.egoComponent );
    }
}
